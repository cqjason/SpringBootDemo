package com.js.springBoot.demo.JSP.controller;

import com.js.springBoot.demo.JSP.domain.LearnResource;
...
public class LearResourceController {
    @RequestMapping("/")
    public ModelAndView index(){
        List<LearnResource> learnList = new ArrayList<LearnResource>();
        LearnResource bean = new LearnResource("official word","Spring Boot Reference Guide","http://docs.spring.io/spring-boot/docs/1.5");
        learnList.add(bean);
